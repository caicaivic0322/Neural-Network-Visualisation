...
After training, update `VisualizerConfig.weightSource` in `assets/config.js` if you export to a different location/name. Refresh the browser to load the new weights.
